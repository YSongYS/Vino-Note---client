...
class LookForm extends React.Component {
  ...
  componentDidMount() {
    if (!!this.props.look_id) {
      API.simpleShowFetch("look", this.props.look_id).then(info =>
        this.setState({
          colorCode: info.color,
          colorName:
            white_colors[info.color] ||
            rose_colors[info.color] ||
            red_colors[info.color],
        ...
        <Grid columns="two" divided>
          ...
          <Grid.Column width={6}>
            ...
            <div className="selected_color">
              ...
              <Rating size="large" rating={this.state.clarity} maxRating={5} />
              <br />
              <br />
              <input
                type="range"
                ...
                onChange={this.handleClarityChange}
              />
              <br />
              <br />
              <br />
              ...
              <input
                ...
                onChange={this.handleViscosityChange}
              />
              <br />
              <br />
              <br />
